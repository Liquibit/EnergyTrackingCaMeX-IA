  ...
  def generate_scorp_io_data(self, link_budget):
    ...
    data = {
      "metrics" : [
        ...
        { "name":"Courant/Phase 1",                   "dataType":"Integer", "timestamp":timestamp, "value":self.current[0]         },
        { "name":"Courant/Phase 2",                   "dataType":"Integer", "timestamp":timestamp, "value":self.current[1]         },
        { "name":"Courant/Phase 3",                   "dataType":"Integer", "timestamp":timestamp, "value":self.current[2]         },
